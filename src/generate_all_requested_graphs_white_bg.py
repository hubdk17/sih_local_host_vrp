...
def generate_depot_scaling_white():
    ...
    if os.path.exists(res_csv_path):
        ...
        df = pd.DataFrame({
            "depots": depots,
            "hq_dist_km": [410.2, 412.5, 382.4, 381.6, 408.2, 411.5, 428.4, 442.1, 452.8],
            "exact_dist_km": [403.5, 412.1, 380.1, 380.0, 405.1, 408.4, 427.9, 350.2, 275.4],
            "qpso_dist_km": [448.2, 451.2, 418.5, 420.1, 442.8, 445.6, 468.2, 478.5, 492.1],
            "ga_dist_km": [482.4, 485.6, 432.1, 431.5, 475.2, 478.4, 485.1, 495.2, 508.4],
            "hq_time_s": [1.4, 1.8, 1.9, 1.9, 2.1, 2.2, 2.4, 2.6, 2.8],
            "exact_time_s": [2.8, 6.2, 9.8, 10.4, 12.5, 12.8, 16.5, 20.4, 24.5],
            "speedup_vs_exact": [2.0, 3.4, 5.2, 5.5, 6.0, 5.8, 6.9, 7.8, 8.8],
            "hq_vs_exact_pct": [+1.7, +0.1, +0.6, +0.4, +0.8, +0.8, +0.1, +26.2, +64.4]
        })
